...
void loop01(void) {
  ...
  display.fillScreen(SSD1306_BLACK);
  display.print_u("ARM architecture (Jan.25,2022,20:57 UTC). In Wikipedia: The Free Encyclopedia. Retrieved from https://en.wikipedia.org/wiki/ARM_architecture");
  sleep_ms(3000);
  ...
  display.set_font_pos(0,  0);
  display.fillScreen(SSD1306_BLACK);
  display.word_print_u("ARM (stylised in lowercase as arm, formerly an acronym for Advanced RISC Machines and originally Acorn RISC Machine) is a family of reduced instruction set computer (RISC) architectures for computer processors, configured for various environments. ");
  sleep_ms(3000);
  ...
  display.fillScreen(SSD1306_BLACK);
  if (display.width() == 128)
      display.word_print_u("Raspberry Pi Pico\n");
  else
      display.word_print_u("Pico\nPico\n");
  sleep_ms(3000);
  ...
  display.set_font_pos(0,  0);
  display.fillScreen(SSD1306_BLACK);
  display.print_u("ARM (stylised in lowercase as arm, formerly an acronym for Advanced RISC Machines and originally Acorn RISC Machine) is a family of reduced instruction set computer (RISC) architectures for computer processors, configured for various environments. ");
  sleep_ms(3000);
  ...
  display.fillScreen(SSD1306_BLACK);
  if (display.width() == 128)
      display.print_u("Raspberry Pi Pico\n");
  else
      display.print_u("Pico\nPico\n");
  sleep_ms(3000);
